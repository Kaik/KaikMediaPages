...
class GalleryUiHooksSubscriber implements HookSubscriberInterface
{
    const DISPLAY_VIEW = 'pages.ui_hooks.gallery.display_view';
    const FORM_EDIT = 'pages.ui_hooks.gallery.form_edit';
    const VALIDATE_EDIT = 'pages.ui_hooks.gallery.validate_edit';
    const PROCESS_EDIT = 'pages.ui_hooks.gallery.process_edit';
    const FORM_DELETE = 'pages.ui_hooks.gallery.form_delete';
    const VALIDATE_DELETE = 'pages.ui_hooks.gallery.validate_delete';
    const PROCESS_DELETE = 'pages.ui_hooks.gallery.process_delete';
    ...
    {
        return $this->translator->__('Pages Gallery area');
    }
