...
class PagesModuleVersion extends \Zikula_AbstractVersion
{
    public function getMetaData()
    {
        ...
        $meta['oldnames']       = array('Pages');
        $meta['version']        = '2.0.0';
        $meta['core_min']       = '1.4.0';
        $meta['securityschema'] = array('KaikmediaPagesModule::' => '::');
        $meta['capabilities'] = array(HookUtil::SUBSCRIBER_CAPABLE => array('enabled' => true));
        $meta['securityschema'] = array('KaikmediaPagesModule::' => 'Page name::Page ID');
        // Module depedencies
    ...
    {
        $bundle = new SubscriberBundle($this->name, 'subscriber.kaikmediapages.ui_hooks.pages', 'ui_hooks',
            $this->__('Pages Hooks')
        );
